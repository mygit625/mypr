...
const featuresByCategory: FeatureCategory[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'PDF to Excel', description: 'Pull data straight from PDFs into Excel spreadsheets in a few clicks.', href: '/pdf-to-excel', Icon: FileSpreadsheet, iconColor: 'text-green-600' },
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'Crop PDF', description: 'Select and crop areas of your PDF pages.', href: '/crop-pdf', Icon: Crop, iconColor: 'text-indigo-400' },
