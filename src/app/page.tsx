...
const toolCategories: ToolCategory[] = [
  ...
  { title: 'URL Shortener', description: 'Create short, manageable links from long URLs for easy sharing.', href: '/url-shortener', Icon: LinkIcon, iconColor: 'text-indigo-500' },
